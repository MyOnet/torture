...
Ohne diesen Schritt läuft die Bestenliste lokal (jeder Browser sieht nur seine eigenen Einträge). Mit diesem Schritt sehen alle Besucher der Seite dieselbe Bestenliste.
